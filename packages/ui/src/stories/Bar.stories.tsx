      ...
      <div>
        <div className='gap-2.2 mb-1.5 flex justify-between text-ui'>
          ...
          <span>
            ...
            <span className='text-ink/55'>of $600.00 budget</span>
          </span>
        </div>
      ...
      <div>
        <div className='gap-2.2 mb-1.5 flex justify-between text-ui'>
          ...
          <span>
            ...
            <span className='text-ink/55'>of $2,000.00</span>
          </span>
        </div>
        <Bar spent={215000} budget={200000} />
        <div className='mt-1.5 text-label text-ink/55'>
  ...
  render: () => (
    <div className='md:grid-cols-2 grid max-w-[900px] gap-6'>
      ...
      <div>
        ...
        <div className='mt-1.5 text-label text-ink/55 tabular-nums'>
